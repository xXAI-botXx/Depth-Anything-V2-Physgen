...
nohup python train.py --variation sound_reflection --input_type osm --output_type standard --model_name phys_any_cfo_1  --model_type complex_focus_only --encoder vitl --batch_size 12 --epochs 100 --lr 0.0005 > ./phys_any_cfo_1.log 2>&1 &
```
